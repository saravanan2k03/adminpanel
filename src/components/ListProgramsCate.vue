<template>
    <div class="flex items-stretch justify-between items-end min-h-[9.2%] pt-3 border-b-2 border-gray-300">
        <div class="h-full min-w-[100%] flex items-center justify-between ">
            <p class="text-3lg text-gray-600 ml-4 font-medium min-w-[50%]">{{ ProgramCategory }}</p>
            <div>
                <div class="flex">
                    <p class="text-3lg text-blue-500  font-medium mr-3">Edit</p>
                    <div class="pr-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_178_4256" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                            <g mask="url(#mask0_178_4256)">
                                <path
